...
class _TimingPageState extends State<TimingPage> with TickerProviderStateMixin {
  ...
  void HandleFetchSent() async {
    List result = await NetworkRequest.fetchNotificationSentSchedule();
    setState(() {
      items = result
          .where((item) =>
              DateTime.parse(item.sendTime).compareTo(DateTime.now()) > 0)
          .toList();
    });
  }
                                                      ...
                                                      children: [
                                                        ...
                                                        const Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            Expanded(
                                                              child: Text(
                                                                "Lorem ipsum dolor sit amet consectetur. Facilisi non tincidunt vel lacus dis.",
                                                                style:
                                                                    TextStyle(
                                                                  fontSize: 16,
                                                                  // fontWeight: FontWeight.w500,
